...
public class KeyWordEngine
{
    ...
    public final String SCENARIO_SHEET_PATH = "D:/Facebook_KeywordDriven/src/main/java/com/qa/scenario/KeywordDriven (1).xlsx";
    ...
    public void startExecution(String sheetName) throws InvalidFormatException {
        ...
        for (int i = 0; i < sheet.getLastRowNum(); i++) {
            try {
                String locatorType = sheet.getRow(i + 1).getCell(k + 1).toString().trim();  // trim -remove space we add by default
